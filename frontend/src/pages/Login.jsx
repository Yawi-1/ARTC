...
import { Eye, EyeOff, Mail, Lock, ArrowRight, User2 } from "lucide-react";
        ...
        <div className="px-8 py-10 sm:px-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-sm transition-all duration-200 mt-2 ${authLoading ? "bg-blue-400 cursor-not-allowed text-white" : "bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white shadow-lg shadow-blue-200 hover:shadow-blue-300"}`}
            >
              {authLoading ? (
                <>
